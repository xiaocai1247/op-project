...
public class ProcessTestDemo1 {
    ...
    public void deployProcess02() {
        Deployment deployment = repositoryService.createDeployment()
                ...
                .name("加班申请流程02")
                .deploy();
        System.out.println("部署流程02id为：" + deployment.getId());
        System.out.println("部署流程02名字为：" + deployment.getName());
    }
    ...
    public void deployProcess01() {
        Deployment deployment = repositoryService.createDeployment()
                ...
                .name("加班申请流程01")
                .deploy();
        System.out.println("部署流程01id为：" + deployment.getId());
        System.out.println("部署流程01名字为：" + deployment.getName());
    }
